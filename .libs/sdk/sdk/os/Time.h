...
struct _os_Time__TimeClass {
    ...
    lang_Numbers__UInt (*measure)(lang_types__Closure);
...
#ifdef OOC_FROM_C
#define GetLocalTime() os_Time__GetLocalTime(())
#define QueryPerformanceCounter() os_Time__QueryPerformanceCounter(())
#define QueryPerformanceFrequency() os_Time__QueryPerformanceFrequency(())
#define Sleep() os_Time__Sleep(())
#define time() os_Time__time(())
#define localtime() os_Time__localtime(())
#define gettimeofday(, ) os_Time__gettimeofday((), ())
#define usleep() os_Time__usleep(())
...
#define Time_measure(action) os_Time__Time_measure((action))
