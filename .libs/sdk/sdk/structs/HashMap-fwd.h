...
#ifndef __FUNC___V__DEFINE
#define __FUNC___V__DEFINE

typedef void (*__FUNC___V)(uint8_t*, void*);
...
#ifndef __FUNC___T_T_SizeT__DEFINE
#define __FUNC___T_T_SizeT__DEFINE

typedef lang_Numbers__SizeT (*__FUNC___T_T_SizeT)(lang_types__Class*, uint8_t*, void*);
...
void structs_HashMap__HashMap_get(structs_HashMap__HashMap* this, uint8_t* __genericReturn76, uint8_t* key);
void structs_HashMap__HashMap_get_impl(structs_HashMap__HashMap* this, uint8_t* __genericReturn76, uint8_t* key);
...
void structs_HashMap__HashMapValueIterator_next(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn78);
void structs_HashMap__HashMapValueIterator_next_impl(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn78);
...
void structs_HashMap__HashMapValueIterator_prev(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn79);
void structs_HashMap__HashMapValueIterator_prev_impl(structs_HashMap__HashMapValueIterator* this, uint8_t* __genericReturn79);
...
void structs_HashMap____OP_IDX_HashMap_K__V(uint8_t* __genericReturn75, lang_types__Class* K, lang_types__Class* V, structs_HashMap__HashMap* map, uint8_t* key);
