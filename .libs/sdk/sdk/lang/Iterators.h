...
struct _lang_Iterators__IterableClass {
    ...
    void (*each_withIndex)(lang_Iterators__Iterable*, lang_types__Closure);
};
...
#define Iterable_reduce(_this_, __genericReturn38, f) lang_Iterators__Iterable_reduce((void*) (_this_), (__genericReturn38), (f))
#define Iterable_each(_this_, f) lang_Iterators__Iterable_each((void*) (_this_), (f))
#define Iterable_each_withIndex(_this_, f) lang_Iterators__Iterable_each_withIndex((void*) (_this_), (f))
...
#define Iterator_next(_this_, __genericReturn43) lang_Iterators__Iterator_next((void*) (_this_), (__genericReturn43))
...
#define BackIterator_prev(_this_, __genericReturn44) lang_Iterators__BackIterator_prev((void*) (_this_), (__genericReturn44))
...
#define ReverseIterator_next(_this_, __genericReturn45) lang_Iterators__ReverseIterator_next((void*) (_this_), (__genericReturn45))
#define ReverseIterator_hasPrev__quest(_this_) lang_Iterators__ReverseIterator_hasPrev__quest((void*) (_this_))
#define ReverseIterator_prev(_this_, __genericReturn46) lang_Iterators__ReverseIterator_prev((void*) (_this_), (__genericReturn46))
