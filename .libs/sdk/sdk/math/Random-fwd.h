...
void math_Random__Random_choice(uint8_t* __genericReturn74, lang_types__Class* T, structs_List__List* l);
...
#define math_Random__srand srand

#define math_Random__rand rand
