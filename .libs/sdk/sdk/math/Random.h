...
#ifdef OOC_FROM_C
#define srand() math_Random__srand(())
#define rand() math_Random__rand()
...
#define Random_choice(__genericReturn74, T, l) math_Random__Random_choice((__genericReturn74), (T), (void*) (l))
